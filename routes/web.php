...
Route::controller(AuthController::class)->group(function () {
    ...
    Route::get('/', 'getLogin')->name('login'); // Afficher le formulaire de connexion
    Route::post('/connexion', 'login')->name('login.post'); // Soumettre le formulaire de connexion
    Route::post('logout', 'logout')->name('auth.logout')->middleware('auth'); // Déconnexion de l'utilisateur
});

// Routes pour AdminController et CategorieController avec middleware auth et admin
...
// Routes pour IdeeController
Route::resource('idees', IdeeController::class);

// Routes pour CommentaireController
